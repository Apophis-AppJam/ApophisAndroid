package com.example.apophis_android.ui.sixthDay.adapter
...
class SixthDayChatAdapter(private val context: Context): RecyclerView.Adapter<RecyclerView.ViewHolder>() {
