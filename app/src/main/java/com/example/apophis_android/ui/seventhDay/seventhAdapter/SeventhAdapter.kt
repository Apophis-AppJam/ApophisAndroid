package com.example.apophis_android.ui.seventhDay.seventhAdapter
...
import com.example.apophis_android.ui.seventhDay.SeventhDayTarotActivity
...
class SeventhChatAdapter(private val context: Context): RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return when (viewType) {
            ...
            R.layout.item_chat_dirt -> {
                val view = layoutInflater.inflate(R.layout.item_chat_tarot, parent, false)
    ...
    inner class SeventhActionViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        private val btnTarot = itemView.findViewById<ImageView>(R.id.seventh_btn_tarot)

        fun bind() {
            btnTarot.setOnClickListener {
                val intent = Intent(context, SeventhDayTarotActivity::class.java)
